...
function BindActionDropdown(TransactionCount) {
    ...
    if (TransactionCount == 0) {
      ...
      //  html = html + "<option value='Transfer'>Transfer</option><option value='Resign'>Resign</option><option value='Terminate'>Terminate</option><option value='Suspend'>Suspend</option>";
        html = html + "<option value='Transfer'>Transfer</option><option value='Resign'>Resign</option><option value='Terminate'>Terminate</option><option value='Suspend'>Suspend</option><option value='Retire'>Retire</option><option value='In Active'>In Active</option><option value='Active'>Active</option>";
