...
function Title() {
    window.location = "wfPmWarehouseMaster.aspx";
}
...
function AddWareHouseEntry() {
    ...
    if ($('#txtWarehouseName').val() != '') {       
            ...
            if ($("#btnSave").html() != 'Update') {
                $.ajax({
                    type: "POST",
                    url: 'wfPmWarehouseMaster.aspx/CheckWarehouseAvailability',
...
function AddWarehouse() {
    $.ajax({
        type: "POST",
        url: 'wfPmWarehouseMaster.aspx/AddWarehouse',
        data: JSON.stringify({
...
function BindBranchDropdown() {
    $.ajax({
        type: "POST",
        url: 'wfPmWarehouseMaster.aspx/BranchList',
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function BindLocationDropdown() {
    $.ajax({
        type: "POST",
        url: 'wfPmWarehouseMaster.aspx/LocationDetails',
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function BindJournalDropdown() {
    $.ajax({
        type: "POST",
        url: 'wfPmWarehouseMaster.aspx/JournalDetails',
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
...
function FetchWarehouseEntry(name) {
    $.ajax({
        type: "POST",
        url: 'wfPmWarehouseMaster.aspx/FetchWarehouseDetails',
        data: JSON.stringify({
            "name":name
            /*"name": name*/
        }),
...
function BindWarehouseMaster() {
    $.ajax({
        type: "POST",
        url: 'wfPmWarehouseMaster.aspx/BindWarehouseMaster',
        data: {},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        beforeSend: function () {
