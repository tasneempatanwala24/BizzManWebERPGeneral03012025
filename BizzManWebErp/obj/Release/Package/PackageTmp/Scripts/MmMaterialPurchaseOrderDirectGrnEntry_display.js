$(document).ready(function () {
    ...
    $.ajax({
        ...
        type: "POST",
        url: "wfMmMaterialPurchaseOrderDirectGrnEntry_display.aspx/FetchPODirectDetails",
        data: JSON.stringify({
            "Id": Id
        }),
    ...
    function populateTable(data) {
        ...
        var tableHTML = '<table class="center" id="search_form" style="width:90%;border:solid 1px black;padding:5px;">'
            ...
            + '</td><td><b>GRN Order ID :</b> ' + data.Table3[0].Id + '<br/><b>Grn Entry Date :</b> ' + data.Table3[0].OrderDate + '</td></tr>'
        ...
        for (var i = 0; i < data.Table4.length; i++) {
            ...
            tableHTML += '<tr><td style="display: none;">' + data.Table4[i].ItemId + '</td><td>'
                ...
                + data.Table4[i].GrossAmt.toFixed(2) + '</td></tr>'
