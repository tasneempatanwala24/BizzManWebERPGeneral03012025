                        ...
                        <table class="tbl" id="tbl_entry">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input type="text" class="form-control" id="txtId" name="txtId" style="display:none;"/>
                                </td>
                                <td style="width:25%;">
                                                ...
                                                <fieldset>
                                                    ...
                                                    <table class="tbl">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Value</td>
                                                            <td><input type="text" class="form-control dcmlNo prcntval" id="txtDAMonthly" name="txtDAMonthly" /></td>
                                                            <td> *12</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Value</td>
                                                            <td><input type="text" class="form-control dcmlNo prcntval" id="txtHRAMonthly" name="txtHRAMonthly"/></td>
                                                            <td> *12</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Value</td>
                                                            <td><input type="text" class="form-control dcmlNo prcntval" id="txtSPLALMonthly" name="txtSPLALMonthly" /></td>
                                                            <td> *12</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Value</td>
                                                            <td><input type="text" class="form-control dcmlNo prcntval" id="txtEDUALMonthly" name="txtEDUALMonthly"/></td>
                                                            <td> *12</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Value</td>
                                                            <td><input type="text" class="form-control dcmlNo prcntval" id="txtLTAMonthly" name="txtLTAMonthly"/></td>
                                                            <td> *12</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Value</td>
                                                            <td><input type="text" class="form-control dcmlNo prcntval" id="txtSTIPMonthly" name="txtSTIPMonthly" /></td>
                                                            <td> *12</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Value</td>
                                                            <td><input type="text" class="form-control dcmlNo prcntval" id="txtMobileAllowanceMonthly" name="txtMobileAllowanceMonthly" /></td>
                                                            <td> *12</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Value</td>
                                                            <td><input type="text" class="form-control dcmlNo prcntval" id="txtBonusMonthly" name="txtBonusMonthly" /></td>
                                                            <td> *12</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td></td>
                                                            <td>Gross</td>
                                                            <td><input type="text" class="form-control dcmlNo" id="txtTotalMonthly" name="txtTotalMonthly" onchange="CalculateGrossToBasicAmnt();" /></td>
                                                            <td> *12</td>
                                                        ...
                                                        <tr>
                                                            <td>ESI Employer %</td>
                                                            <td><input type="text" class="form-control dcmlNo" id="txtESIEmployerPercentEarn" name="txtESIEmployerPercentEarn" onchange="calEsi();" /></td>
                                                            <td>Value</td>
