<%@ Page Title="Employee Loan Master" Language="C#" MasterPageFile="~/ExternalPage.Master" AutoEventWireup="true" CodeBehind="wfHrEmpLoanApplicationMasterIndivisual.aspx.cs" Inherits="BizzManWebErp.wfHrEmpLoanApplicationMasterIndivisual" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Scripts/wfHrEmpLoanApplicationMasterIndivisual.js"></script>
    <style>
        .button {
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <a style="display: none;" id="btnViewFile" class="button" onclick="ViewFile()">View File</a>
