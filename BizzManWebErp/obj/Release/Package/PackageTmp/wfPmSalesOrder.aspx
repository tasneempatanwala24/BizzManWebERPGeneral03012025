<%@ Page Title="" Language="C#" MasterPageFile="~/PM.Master" AutoEventWireup="true" CodeBehind="wfPmSalesOrder.aspx.cs" Inherits="BizzManWebErp.wfPmSalesOrder" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Scripts/PmSalesOrder.js?0005"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <%-- <button onclick="DownloadFile();" id="btnExport">Export To Excel</button>--%>
    ...
    <div class="container" id="divSalesOrderList" style="margin-top: 10px; overflow: auto;">
        <table id="tblSalesOrderList" class="display" style="width:280%;">
            <thead>
                <tr>
                   <%-- <th>
                         <input name="select_all" value="1" id="example-select-all" type="checkbox" /></th>--%>
                 
                    <th style="width: 5%;">Sales Order Id</th>
                    ...
                    <th style="width: 5%;">GST Treatment</th>
                    <th style="width: 5%;">Expiration Date</th>
                    <th style="width: 5%;">Quotation Id</th>
                    <th style="width: 5%;">Currency</th>
                    <th style="width: 5%;">Payment Terms</th>
                    <th style="width: 5%;">Service Charge</th>
            ...
            <tbody id="tbody_SalesOrder_List" class="client-list-contents">
            </tbody>
        </table>
    </div>
                    ...
                    <div class="panel-body">
                        <table class="tbl" id="tbl">
                            ...
                            <tr>
                                <td>Currency *</td>
                                <td>
                                    <select id="ddlCurrency" name="ddlCurrency" class="form-control" style="width: 300px;" onchange="GenerateQuotationID()">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" class="form-control" id="txtServiceCharges" name="txtServiceCharges" value="0" oninput="handleNumericInput(event)" onchange="calculateGrandTotal()" />
                                </td>
                                <td>Total Amount</td>
                                <td>
                        ...
                        <table id="tblSalesOrderBOMDetails" class="display no-footer dataTable" style="width: 100%;">
                            ...
                            <tbody id="tbody_SalesOrderDetails">
                                <tr id="tr_SalesOrderDetailEntry">
                                    ...
                                    <td>
                                        <select id="ddlMaterialName" name="ddlMaterialName" class="form-control" style="width: 100%;" onchange="FetchMaterialDetails();">
