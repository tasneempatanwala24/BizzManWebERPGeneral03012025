<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ExternalPage.Master" CodeBehind="wfPmSurveyTaskAssigned.aspx.cs" Inherits="BizzManWebErp.wfPmSurveyTaskAssigned" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Scripts/PmSurveyTaskAssigned.js?0002"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <button onclick="ViewSurveyTaskList();">View</button>
