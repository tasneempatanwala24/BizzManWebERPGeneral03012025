<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfSdBomMaster_display.aspx.cs" Inherits="BizzManWebErp.wfSdBomMaster_display" %>
...
<head runat="server">
    ...
    <script src="Scripts/SdBomMaster_display.js"></script>
    <title></title>
    <style>
...
<body>
    ...
    <script>
      function getContentInPDF() {
          ...
          html2pdf().from(element).save('SDBOM.pdf');
      }
    </script>
</body>
</html>
