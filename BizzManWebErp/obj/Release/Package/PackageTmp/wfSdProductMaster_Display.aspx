<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfSdProductMaster_Display.aspx.cs" Inherits="BizzManWebErp.wfSdProductMaster_Display" %>
...
<head runat="server">
    ...
    <script src="Scripts/SdProductMaster_Display.js"></script>
    <title></title>
    <style>
...
<body>
    ...
    <script>
      function getContentInPDF() {
          ...
          html2pdf().from(element).save('ProductMaster.pdf');
      }
    </script>
</body>
</html>
