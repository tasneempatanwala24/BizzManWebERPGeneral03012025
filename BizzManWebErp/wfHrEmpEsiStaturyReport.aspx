<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="wfHrEmpEsiStaturyReport.aspx.cs" Inherits="BizzManWebErp.wfHrEmpEsiStaturyReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Scripts/HrEmpEsiStaturyReport.js"></script>
    ...
    <div class="container" id="divEmployeeSaleryApproveList" style="margin-top: 10px; overflow: auto;">
        <table class="tbl">
            <tr>
                ...
                <td>
                    <select id="ddl_Branch" name="ddl_Branch" class="form-control" onchange="BindEmployeeFilter();">
                    </select>
                </td>
                ...
                <td>
                                    <label class="control-label">Salary Type</label></td>
                                <td>
                    ...
                    <div class="panel-body">
                        <table class="tbl" id="tbl_entry">
                            ...
                            <tr>
                                ...
                                <td class="Individual">
                                    <select id="ddlEmployee" name="ddlEmployee" class="form-control" style="width: 100%!important;" 
                                        onchange="ShowEmployeeName();">
