...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <button id="exportToExcel">Download</button>
                    ...
                    <tr>
                        ...
                        <td style="width: 50%" colspan="2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" style="width: 100%;" class="form-control rounded border-dark" id="txtMaterialName" name="txtMaterialName" placeholder="please enter material name"/>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" style="width: 100%;" class="form-control rounded border-dark dcmlNo" id="txtMrp" 
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" style="width: 100%;" class="form-control rounded border-dark" id="txtMinimumStockLevel" 
                                        name="txtMinimumStockLevel" placeholder="please enter minimum stock level" />
                                </td>
                                <td style="width: 15%;">Maximum Stock Level </td>
                                <td>
                                    <input type="number" style="width: 100%;" class="form-control rounded border-dark" id="txtMaximumStockLevel" 
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" style="width: 100%;" class="form-control rounded border-dark" id="txtHsnNo" 
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" style="width: 100%;" class="form-control rounded border-dark" 
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" style="width: 100%;" class="form-control rounded border-dark dcmlNo4"
                                        id="txtLinkItemQty" name="txtLinkItemQty" placeholder="please enter link item qty"/>
                                </td>
                                <td style="width: 7%;">Link Item Unit Measure</td>
                                <td>
                                    <input type="text" style="width: 100%;" class="form-control rounded border-dark" 
                                        id="txtLinkItemUM" name="txtLinkItemUM" />
                                </td>
                            </tr>
                           <tr>
                               ...
                               <td>Alias</td>
                                <td>
                                    <input type="text" style="width: 100%;" class="form-control rounded border-dark" id="txtalias" 
                           ...
                           <tr>
                               ...
                               <td>
                                   <select style="width: 100%;" id="ddlActive" name="ddlActive" class="form-control rounded border-dark">
