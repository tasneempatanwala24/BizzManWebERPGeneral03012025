<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfSdSalesQuotationOrder_display.aspx.cs" Inherits="BizzManWebErp.wfSdSalesQuotationOrder_display" %>
    ...
    #search_form1 tr td{
      ...
      <script>
          ...
          function GetPDFContent(id) {
              $.ajax({
                  type: 'POST',
                  url: 'wfSdSalesQuotationOrder_display.aspx/GetQuotationData',
